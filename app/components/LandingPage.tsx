...
const LandingPage = () => {
    return (
        <div>
                ...
                <div className='flex flex-col items-start ml-28'>
                    ...
                    <div className='mt-8'>
                        <ul className='flex flex-row items-center gap-x-24'>
                            <li className='hover:animate-ping hover:cursor-pointer'>
                            ...
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-envelope w-10 h-auto" viewBox="0 0 16 16">
            ...
            <div className='mt-96 border-white border-2 rounded-lg '>
                <div className='py-14 pl-28'>
