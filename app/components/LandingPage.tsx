                ...
                <div className='flex flex-col items-start ml-28'>
                    ...
                    <div className='mt-8'>
                        <ul className='flex flex-row items-center gap-x-24'>
                            <a href={"https://github.com/jacob-s-codes"} target='_blank'><li className='hover:text-blue-500 hover:scale-110 text-white hover:cursor-pointer'>
                            ...
                            <a href={"mailto: jacobbshaul@gmail.com"}><svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-envelope w-10 h-auto" viewBox="0 0 16 16">
