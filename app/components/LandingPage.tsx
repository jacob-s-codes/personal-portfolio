    ...
    return (
        <div className='text-primary flex flex-row items-center justify-evenly mt-40'>
            <div className='flex flex-col items-start gap-y-24'>
                ...
                <h2 className='max-w-xl text-2xl'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nulla alias error consequuntur itaque laboriosam recusandae doloribus quam excepturi quo nostrum.</h2>
            </div>
