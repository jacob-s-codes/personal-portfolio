        ...
        <div>
            ...
            <div className='flex flex-row items-center justify-center gap-36'>
                ...
                <SpotlightBorder className="h-[650px] w-96 bg-[#667a8a] duration-500   hover:shadow-xl hover:shadow-white " spotlightColor="white">
                        ...
                        <div className='flex w-full justify-center'>
                            <Link href="/modetocode"><button className='border-white border-2 rounded-lg px-4 py-4 hover:bg-white hover:text-black duration-500 hover:cursor-pointer'>Learn more</button></Link>
                        </div>
                    </SpotlightBorder>
                </div>
            </div>
