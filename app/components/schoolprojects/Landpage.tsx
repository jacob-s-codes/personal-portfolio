...
const Landpage = () => {
  return (
    <div className='text-white'>
      <h1 className='text-9xl text-center mt-8'>School Projects</h1>
      ...
      <div className='flex flex-row items-center justify-center mt-56 gap-x-12'>
        ...
        <div className='w-full mr-24'>
          <Image src={englishImage} width={500} height={500} className='w-full rounded-md' alt="image of english picture"></Image>
        </div>
      </div>
    </div>
  )
